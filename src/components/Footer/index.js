      ...
      <div className="footer__section footer__section--first">
        <div className="footer__container">
          <p>
            ...
            Observação: este site é uma amostra de desenvolvimento tecnológico
            ...
            conferir as informações diretamente com o estabelecimento. A
            exibição dos locais, nesta página não caracteria recomendação de
            uso.
          </p>
        </div>
      </div>
      ...
      <div className="footer__section footer__section--second">
        <div className="footer__container">
          <p>
            ...
            <small>
              Projetado por Caique Oliveira, desenvolvido por Aluno EBAC.
            </small>
          </p>
